...
public class Score3 {
    ...
    // 다음 연산자는 계산을 수행 할 때마다 인스턴스의 주소를 파라미터로 받아야 한다.
    ...
    */
    ...
    // 인스턴스 메서드를 사용하면 인스턴스 데이터를 사용하는데 훨씬 편리하다.
    // 이 this라는 내장변수에는 주소가 저장된다.
    
    // static이 붙은 변수 - 클래스 변수
    // static이 안붙은 변수 - 인스턴스 변수
    public void calculator() {
        this.sum = this.kor + this.eng + this.math; // this - 빌트 인 변수
