...
// => 컨테이너는 객체의 '생성-실행-소멸' 즉 객체의 생명주기(lifecycle)를 관리하는 것을 말한다.
// => 대표적인 라이브러리가 "스프링 IoC 컨테이너" 이다.
//
// IoC 컨테이너(Inversion of Control 컨테이너)?
// => IoC 컨테이너 = 빈 컨테이너 + 의존 객체(Inject Dependancy) 자동 주입
// Exam10은 ApplicationContext8에 의존한다.
// ex) 안경이 없다면 볼수 없다 -> 안경이 의존객체
