...
public class Exam01_2 {
    public static void main(String[] args) {
        ...
        // 다양한 타입의 메모리를 묶어서 Score라는 
        // 새로운 형태의 메모리를 만들 수 있는 설계도.
        // -> 메모리는 아직 만들어진 상태가 아니다.
        // => 개발자(= 자바 언어를 쓰는사람)가 새롭게 정의한 데이터 타입이다.
        // => "사용자(개발자) 정의 데이터 타입" 이라 부른다.
        //     개발자가 원하는대로 만든 설계도
        ...
        //    그냥 메모리를 확보만 해 놓으면 그 메모리의 주소값을 모르기 때문에
        //    사용할 수 없다. 따라서 주소를 보관해야 한다.
        // => 주소를 보관하면 레퍼런스가 필요하다.

        Score s; // => Score 설계도에 따라 메모리의 주소를 저장할 변수.
