...
public class Exam02_7 {
    ...
    //    예) m1("aaa", "bbb", "ccc");
    //    -> 이 경우 어느 값이 names 배열에 들어가고,
    //       어느 값이 names2 배열에 들어가는가?
    // static void m1(String... names, String... names2) {} // 컴파일 오류!!
    // static void m1(String... names, int a, String... names2) {} // 컴파일 오류!!
    // 위의 메서드는 값을 구분할 수 있을것 같은데..?
    // => 사람은 쉽게 구분할수 있다
    //    but!! 컴파일러가 이런 상황을 구분하려면 굉장히 복잡해진다!
    // => 가변 파라미터라는 문법의 이점은 사용하되
...
// * format 이나 printf 도 내부적으로 가변 파라미터를 사용한다.
// java8 api
