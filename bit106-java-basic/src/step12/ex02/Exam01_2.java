...
// 2) 속도
// ArrayList
//    => 배열의 특징 상 인덱스를 이용하여 특정 항목을 찾을 때 속도가 빠르다.(방을 바로 찾을 수 있다.)
//    => 삭제할 때 이전 항목을 당겨와야 하기 대문에 속도가 느리다.(10000개에서 1번째것을 삭제한다면 10000번을 모두 당겨야한다.)
//    => 입력할 때 현재 항목을 다음 항목으로 이동해야 하기 대문에 속도가 느리다.(10000개에서 1번째것을 삭제한다면 10000번을 모두 밀어야한다.)
// LinkedList
//    => 인덱스를 이용하여 특정 항목을 찾을 때 리스트의 처음부터 찾아야 하기 때문에 속도가 느리다.(카운트 하면서 찾아야 한다.)
