...
public class Exam03_1 {
    static class A {
        ...
        void m3() {
            ...
            // 실무에서 this를 붙이는 경우가 있고 붙이지 않는 경우가 있다.
            // 붙어있는 경우에는 인스턴스 변수임을 강조하기 위해서 붙이는 것이다.
        }
        void m4(int value) {
            // 로컬 변수의 이름이 인스턴스 이름과 같을 경우
            // this를 붙이지 않으면 로컬 변수를 가리킨다.
            value = 200; // 기본적으로 붙이지 않으면 로컬변수.
            
            this.value = 300; // 인스턴스 변수이다.
            // 따라서 인스턴스 변수를 가리키고 싶으면 this를 붙여야 한다. => 생략할 수 없다.
        }
    }
    public static void main(String[] args) {
        ...
        // 그래서 메서드가 호출 될 때마다 this 변수의 값이 바뀐다.
        obj2.m2();
    }
}
