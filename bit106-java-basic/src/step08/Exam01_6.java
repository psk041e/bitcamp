...
public class Exam01_6 {
    ...
    public static void main(String[] args) {
        ...
        // 남의 소스 코드를 유지보수하는 사람은 더더욱 숫자의 의미를 파악하란 어렵다.
        // 주석이나 개발 문서를 자세히 살펴보지 않는 이상에는 숫자의 의미를 파악하기 쉽지 않은것이 현실이다.
        //
        // "이런 경우를 방지하고 나온 문법이 상수이다!"
        ...
        // Member.MANAGER = 200; // 이를 방지하기 위해 final을 붙인다.
