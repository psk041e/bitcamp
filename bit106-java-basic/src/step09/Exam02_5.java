...
public class Exam02_5 {
    public static void main(String[] args) throws Exception {
        ...
        // 다른 패키지에서 직접 생성자를 호출할 수 없다. -> Car2클래스 참고
        ...
        // 인스턴스 메서드 활용 (ctrl누른 후 Calendar 클릭하면 년도,월,일,요일 등을 출력해주는 숫자를 볼수있다.)
        System.out.println(c.get(1)); // 년도를 뽑아주게끔 get이라는 메서드가 내장되어있다.
        System.out.println(c.get(2) + 1); // 월(0 ~ 11)
        System.out.println(c.get(5)); // 일
        System.out.println(c.get(7)); // 요일(1 ~ 7) 토요일: 주말(주의 마지막날), 일요일: 주의 첫째날
        System.out.println(c.get(4)); // 그 달의 몇번째 주
        System.out.println(c.get(10)); // 시(0 ~ 11)
        System.out.println(c.get(11)); // 시(24시 기준)
        System.out.println(c.get(12)); // 분
        System.out.println(c.get(13)); // 초
        
        // 상수의 활용 -> step08의 Exam01_6참고
        // 숫자를 암기하기 힘들다 -> 내부적으로 상수가 정의되어있다.
        System.out.println(c.get(Calendar.YEAR)); // 년도를 뽑아주게끔 get이라는 메서드가 내장되어있다.
        System.out.println(c.get(Calendar.MONTH) + 1); // 월(0 ~ 11)
        System.out.println(c.get(Calendar.DATE)); // 일
        System.out.println(c.get(Calendar.DAY_OF_WEEK)); // 요일(1 ~ 7) 토요일: 주말(주의 마지막날), 일요일: 주의 첫째날
        System.out.println(c.get(Calendar.WEEK_OF_MONTH)); // 그 달의 몇번째 주
        System.out.println(c.get(Calendar.HOUR)); // 시(0 ~ 11)
        System.out.println(c.get(Calendar.HOUR_OF_DAY)); // 시(24시 기준)
