...
public class TaskController {
    ...
    public String delete(
        ...
        // 팀 이름은 파라미터로 넘어오지 않고 pathVariable로 넘어온다. 경로에서 추출하겠다. 
        // 이 변수명은 경로에 있는 변수명과 같아야 한다.
    ...
    public String list(
        ...
        HashMap<String,Object> params = new HashMap<>();
        params.put("startRowNo", (pageNo - 1) * pageSize); // map으로 받는것도 가능하지만 클라이언트가 마음대로 조작할수 있기 때문에 이렇게 하겠다.
