...
public class BoardDao extends AbstractDao<Board> {
    ...
    public void load() throws Exception {
        ...
        // 지정된 파일로 출력을 하는 도구
        // 한 문자, 문자열 배열을 출력할수는 있지만 문자열 배열을 출력할수는 없다.
        while (true) {
            // 저장된 데이터를 한 줄 읽는다.
    ...
    public void save() throws Exception {
    	...
    	// FileWriter는 문자열을 출력하는 형식이 없어서 PrintWriter를 통해 출력해준다.
    	
    	Iterator<Board> boards = this.list();
    	
    	// List에 보관된 데이터를 board.csv 파일에 저장된다.
