// 요청 핸들러의 파라미터 - @RequestBody를 사용하여 통으로 넘어온 값을 받기 (단, post방식으로 javascript로 넘겨야 한다.)
...
public class Exam05_9 {
    ...
    public String m2(
            ...
            // 통으로 값이 넘어올 때는 개별 변수를 받을 수 없다.
            // 통으로 받아야 한다. 변수명은 어차피 상관 없다.
    ...
    public String m4(
        ...
        return String.format("m4(): name=%s, age=%s, tel=%s", 
